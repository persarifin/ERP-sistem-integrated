...
{
  public function __construct(UserAttachmentRepository $repository)
  {
  ...
  public function store(UserAttachmentRequest $request) {
    return $this->repository->store($request);
  }

  public function update($id, UserAttachmentRequest $request)
  {
